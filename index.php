...
$casesArray = new WP_Query(array(
  ...
  <div data-spy="scroll" data-target="#primary-menu" data-offset="0">
    <div class="container mx-auto">
      ...
      <div class="row mt-5" id="id-our-team">
        <div class="col">
      ...
      <?php foreach($usersArray as $user): ?>
        <div class="col mb-4">
          <div class="card border-0 bg-transparent our-team">
            <div class="row no-gutters">
              <div class="col-md-3 rounded-lg">
                <img class="card-img rounded-lg" src="<?php echo get_avatar_url( $user->ID ) ?>" alt="">
              </div>
              <div class="col-md-9">
                <div class="card-body">
